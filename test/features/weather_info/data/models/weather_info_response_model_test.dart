...
import 'package:flutter_architecture/features/weather_info/data/models/weather_info_response_model/weather_info_response_model.dart';
...
void main() {
  final WeatherInfoResponseModel _weatherInfoResponseModel =
    ...
    cloudsData: CloudsResponseModel(all: 20,),
  ...
  test(
    ...
    () async {
      //assert
      expect(_weatherInfoResponseModel.mapToDomainModel(),
  ...
  group('test fromJson() function', () {
    test(
      ...
      () async {
        ...
        //act
        final WeatherInfoResponseModel result = WeatherInfoResponseModel.fromJson(_jsonMap);
        //assert
        expect(result.mapToDomainModel(), _weatherInfoResponseModel.mapToDomainModel());
      },
    );
  });
}
